...
func (o *RemoteProductServiceImpl) GetRemoteStockByLocationIDAndProductID(ctx context.Context, locationID, prodID int64) (domain.Stock, error) {
	...
	log.Println("!!!!!!!!!! remote stock response ", stockResponse)

	return utilMap(stockResponse), nil
}

// SetRemoteStockQuantity implement interface
func (o *RemoteProductServiceImpl) SetRemoteStockQuantity(ctx context.Context, locationID, productID int64, stock domain.Stock) error {
